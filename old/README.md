...
Listen to the Animal Crossing hourly background music (BGM) in real life (IRL) based on _your_ local time and weather. Chill lo-fi music for study/sleep/relaxation.
...
- It now accepts input from the viewer for a _city, country_ and will display the time and weather for that location
